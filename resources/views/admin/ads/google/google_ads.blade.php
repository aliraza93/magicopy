...
<div class="row">
    <div class="col-12">
        <div class="page-title-box">
            ...
            <h4 class="page-title">{{request()->is('facebook-ad')?'Facebook':'Google'}} Ad </h4>
        </div>
    </div>
</div>
<!-- end page title -->
                        ...
                        <div style="margin-top: 20px;">
                            <div style="margin-bottom: 8px; margin-top: 8px; width: 100%;">
                                ...
                                <div class="form-group dynamic-field" id="dynamic-field-1">
                                     ...
                                     <input type="text" class="form-control" id="avoid_keyword"
                                        name="avoid_keyword" value="{{old('avoid_keyword')}}" placeholder="avoid keywords"
                                        autocomplete="off"> 
                                </div>
    ...
    <div class="card-box">
        <div class="sc-dFJsGO liTBVH">
            ...
            <div
                ...
                Your {{request()->is('facebook-ad')?'Facebook':'Google'}} Ads are empty right now.<br>When you generate new ads they will appear here.
            </div>
        </div>
